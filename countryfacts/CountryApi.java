    ...
    public static List<Country> extractFeatureFromJson(String restCountryResponse) {
        ...
        try {
            ...
            for (int i = 0; i < baseJsonResponse.length(); i++) {
                ...
                String countryNativeName= currentCountry.getString( "nativeName" );
                String countryCapital = currentCountry.getString("capital");
                String populationView = currentCountry.getString("population");
                String AreaSizeView = currentCountry.getString("area");
                String RegionNameView = currentCountry.getString("region");
                String timeZoneView=currentCountry.getString( "timezones" );
                String SubRegionNameView = currentCountry.getString("subregion");

                // get the currencies array and the first object in it
                // extract currency code and symbol from it
                ...
                Country country =
                        new Country(countryName, currencyCode, currencySymbol, languageName,countryCapital,populationView,AreaSizeView,RegionNameView,timeZoneView,SubRegionNameView,countryNativeName);
